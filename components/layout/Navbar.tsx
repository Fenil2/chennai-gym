  ...
  return (
    <nav
      className={cn(
        ...
        scrolled
          ? "bg-[#0B0B0B]/95 backdrop-blur-xl border-b border-white/8 py-3"
          : "bg-transparent py-5"
      )}
    >
      ...
      >
        <div className="flex flex-col gap-5 border-t border-white/10 bg-[#0B0B0B]/98 px-4 py-6 backdrop-blur-xl sm:px-6">
          {navLinks.map((link) => (
            <Link
              key={link.href}
              href={link.href}
