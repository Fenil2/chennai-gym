...
export default function FinalCTA() {
  return (
    <section
      id="contact"
      className="relative overflow-hidden bg-[#0E0E0E] px-4 py-24 sm:px-6 sm:py-36"
    >
      <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(255,255,255,0.02)_0%,rgba(255,255,255,0)_100%)]" />
      <div className="pointer-events-none absolute inset-x-4 bottom-6 top-6 rounded-[1.5rem] border border-white/6 sm:inset-x-6 sm:bottom-10 sm:top-10 sm:rounded-[2rem]" />
      ...
      <div className="container relative z-10 mx-auto max-w-4xl text-center">
        ...
        >
          <span className="mb-7 inline-block rounded-full border border-[#FF2E2E]/30 bg-[#FF2E2E]/10 px-4 py-1.5 text-xs font-semibold uppercase tracking-widest text-[#FF2E2E]">
            Start Today
          </span>

          <h2 className="mb-6 text-4xl font-black leading-[1.08] tracking-tight sm:text-5xl md:text-7xl">
            Stop Waiting.{" "}
