...
export default function WhyUs() {
  return (
    <section id="why-us" className="bg-[#0B0B0B] px-4 py-24 sm:px-6 sm:py-28">
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((feature, index) => (
            <AnimatedSection key={feature.title} delay={index * 0.08}>
              <div className="group h-full rounded-2xl border border-white/10 bg-[#121212] p-6 transition-all duration-300 hover:border-[#FF2E2E]/25 hover:bg-[#171717] sm:p-8">
                <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-xl border border-[#FF2E2E]/30 bg-[#FF2E2E]/10 transition-colors duration-300 group-hover:border-[#FF2E2E]/45 group-hover:bg-[#FF2E2E]/18">
